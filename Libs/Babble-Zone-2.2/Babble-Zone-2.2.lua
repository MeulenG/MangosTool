...
BabbleZone:RegisterTranslations("enUS", function()
	return {
		...
		["Kargath"] = true,
		["Lethlor Ravine"] = true,
		["Maker's Terrance"] = true,
		["Blasted Lands"] = true,
		["Dark Portal"] = true,
		["Dreadmaul Post"] = true,
		["Nethergarde Keep"] = true,
		["Altar Of Storms A"] = true,
		["Altar Of Storms B"] = true,
		["Blackrock Depths"] = true,
		["Blackwing Lair"] = true,
		...
		["Magic Quarter"] = true,
		["Caer Darrow"] = true,
		["Caer Darrow The Dark Portal"] = true,
		["Dalson's Tears"] = true,
		["Felstone Field"] = true,
		["Fungal Vale"] = true,
		...
		["Bashal'Aran"] = true,
		["Blackwood Den"] = true,
		["The Clifspring River"] = true,
		["Darkshore"] = true,
		["Grove of the Ancients"] = true,
		["Long Wash"] = true,
		["Master's Glaive"] = true,
		["Mist's Edge"] = true,
		["Aldrassil"] = true,
		["The Cenarion Enclave"] = true,
		["Craftsmen's Terrance"] = true,
		["Darnassus"] = true,
		["Desolace"] = true,
		["Gelkis Village"] = true,
